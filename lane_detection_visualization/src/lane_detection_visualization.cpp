...
public:
    ...
    {
        //create publisher for visualization messages
    ...
    void laneMarkingCallback(lane_msgs::msg::LaneMarkingProjectedArrayBoth::SharedPtr msg)
    {
        ...
        //fill the "points" field in the marker with the coordinates of recieved projected left lanemarkings
        ...
        //fill the "points" field in the marker with the coordinates of recieved projected right lanemarkings
